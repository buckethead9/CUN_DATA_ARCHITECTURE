-- =============================================================================
-- Ledger Docente CUN 2026 -- Star Schema DDL (VERSIÓN MySQL)
-- =============================================================================
...
CREATE TABLE LOG_TRANSACCIONAL_FEEDBACK (
    ...
    IMPACTO_REAL             NUMERIC(6,4)   NOT NULL,      
    COD_FEEDBACK             VARCHAR(20),                  
    COD_FEEDBACK_ESTIMADO    VARCHAR(150),                 
